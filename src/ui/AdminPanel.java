...
public class AdminPanel extends JPanel {
    ...
    private void addInput(JPanel p, GridBagConstraints gbc, int y, String label, Component cmp) {
        ...
        gbc.gridx = 1;
        if(cmp instanceof JTextField) Theme.styleTextField((JTextField)cmp);
        ...
        try {
            ...
            while(rs.next()) {
                model.addRow(new Object[]{
                    rs.getString("full_name"), rs.getInt("score"), rs.getString("difficulty_level"), rs.getString("date_taken")
                });
            }
